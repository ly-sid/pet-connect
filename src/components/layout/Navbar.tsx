        ...
        <nav className={styles.navbar}>
            <div className={styles.container}>
                ...
                <div className={`${styles.navLinks} ${isMenuOpen ? styles.open : ''}`}>
                    ...
                    {/* Add authButtons inside navLinks for mobile view if menu is open */}
                    {isMenuOpen && (
                        <div className={`${styles.authButtons} ${styles.open}`}>
                            {user ? (
                                <div className={styles.userMenu}>
                                    <Button size="sm" variant="outline" onClick={() => { logout(); setIsMenuOpen(false); }}>Log out</Button>
                                </div>
                            ) : (
                                <>
